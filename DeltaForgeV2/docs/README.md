...
## Governor-Limit Design Pattern (New)
- [Technical Specification: Governor-Limit Pattern](docs/DeltaForge_GovernorLimit_Technical_Spec.md)
- [Design Document: Governor-Aware Orchestration](docs/DeltaForge_GovernorLimit_Design_Doc.md)

These documents introduce **Governor-Aware Orchestration** with adaptive budgeting, quantized execution, deterministic spillover, and compaction strategies to prevent CPU, SOQL, DML, heap, and callout limit violations while preserving determinism and idempotency.
